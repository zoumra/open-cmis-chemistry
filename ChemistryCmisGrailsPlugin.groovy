class ChemistryCmisGrailsPlugin {
    ...
    def title = "Chemistry Cmis Plugin" // Headline display name of the plugin
...
'''
    ...
    def documentation = "http://grails.org/plugin/chemistry-cmis"
...
//    def license = "APACHE"
    ...
    def developers = [ [ name: "Ludovik Lacroix", email: "ludovik@lacroix.in" ]]
